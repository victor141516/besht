...
func main() {
	...
	opts := codegen.Options{NoCheck: noCheck, Strict: strict, NoSourceMap: noSourceMap, ResolveTsImports: resolveTSImports, AllowExternalShellImports: allowExternalShellImports, UseJQ: useJQ}
