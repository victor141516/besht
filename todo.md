...
- `value.toString()`, `String(value)`, `string.localeCompare(other)`, `Number.parseInt(value)`, global `parseInt(value)`, and global `parseFloat(value)` for common conversion and scalar string ordering.
