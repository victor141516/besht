...
`)
	outDir := filepath.Join(dir, "out")
	if err := codegen.CompileFileSplit(filepath.Join(dir, "main.bsh"), outDir, codegen.Options{NoCheck: true, NoSourceMap: true}); err != nil {
	...
	main := string(mainBytes)
	assertContains(t, main, "# Generated by besht — do not edit by hand\n\n_BESHT_ROOT=")
	assertNotContains(t, main, "# Generated by besht — do not edit by hand\n\n\n_BESHT_ROOT=")
}
